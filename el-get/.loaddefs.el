...
(register-definition-prefixes "anzu/anzu" '("anzu"))
...
(autoload 'tsv-mode "csv-mode/csv-mode" "\
Major mode for editing files of tab-separated value type.

\(fn)" t nil)

(register-definition-prefixes "csv-mode/csv-mode" '("csv-" "tsv-"))

;;;***

;;;### (autoloads nil "csv-mode/csv-mode-tests" "csv-mode/csv-mode-tests.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from csv-mode/csv-mode-tests.el

(register-definition-prefixes "csv-mode/csv-mode-tests" '("csv-tests--"))
...
Font Lock mode face used to highlight tags." :group 'etags-select-mode)
...
;;;***

;;;### (autoloads nil "fold-this/fold-this" "fold-this/fold-this.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from fold-this/fold-this.el

(autoload 'fold-this "fold-this/fold-this" "\
...
(autoload 'fold-this-sexp "fold-this/fold-this" "\
...
(autoload 'fold-this-all "fold-this/fold-this" "\
Fold  all occurences of text in region.

\(fn BEG END)" t)

(autoload 'fold-this-mode "fold-this/fold-this" "\
...
(custom-autoload 'fold-this-persistent-mode "fold-this/fold-this" nil)

(autoload 'fold-this-persistent-mode "fold-this/fold-this" "\
...
(register-definition-prefixes "fold-this/fold-this" '("fold-"))
...
(autoload 'ffip-git-diff-current-file "ffip/find-file-in-project" "\
...
(custom-autoload 'ffip-find-relative-path-callback "ffip/find-file-in-project" t)
...
(autoload 'ffip-find-files-resume "ffip/find-file-in-project" "\
...
(autoload 'find-file-in-project-at-point "ffip/find-file-in-project" "\
...
(autoload 'ffip-insert-file "ffip/find-file-in-project" "\
Insert contents of file in current buffer.
The file name is selected interactively from candidates in project." t)

(autoload 'find-file-with-similar-name "ffip/find-file-in-project" "\
...
(autoload 'ffip-find-relative-path "ffip/find-file-in-project" "\
...
(autoload 'ffip-lisp-find-file-in-project "ffip/find-file-in-project" "\
...
(autoload 'ffip-diff-mode "ffip/find-file-in-project" "\
Show diff/patch.

In addition to any hooks its parent mode `diff-mode' might have run, this mode
runs the hook `ffip-diff-mode-hook', as the final or penultimate step during
initialization.

\\{ffip-diff-mode-map}" t)

(autoload 'ffip-show-diff-internal "ffip/find-file-in-project" "\
...
(autoload 'ffip-show-diff-by-description "ffip/find-file-in-project" "\
Show the diff output by executing selected `ffip-diff-backends'.
...
(autoload 'ffip-diff-apply-hunk "ffip/find-file-in-project" "\
...
(autoload 'ffip-diff-filter-hunks-by-file-name "ffip/find-file-in-project" "\
...
(autoload 'ffip-fix-file-path-at-point "ffip/find-file-in-project" "\
...
(register-definition-prefixes "ffip/find-file-in-project" '("ffip-"))
...
;;;***

;;;### (autoloads nil "jinx/jinx" "jinx/jinx.el" (0 0 0 0))
;;; Generated autoloads from jinx/jinx.el
...
(autoload 'jinx-languages "jinx/jinx" "\
...
(autoload 'jinx-correct-all "jinx/jinx" "\
Correct all misspelled words in the buffer." t)

(autoload 'jinx-correct-nearest "jinx/jinx" "\
Correct nearest misspelled word." t)

(autoload 'jinx-correct-word "jinx/jinx" "\
...
(autoload 'jinx-correct "jinx/jinx" "\
...
(custom-autoload 'global-jinx-mode "jinx/jinx" nil)

(autoload 'global-jinx-mode "jinx/jinx" "\
...
(register-definition-prefixes "jinx/jinx" '("global-jinx-modes" "jinx-"))
...
;;;***

;;;### (autoloads nil "llama/llama" "llama/llama.el" (0 0 0 0))
;;; Generated autoloads from llama/llama.el

(autoload 'llama "llama/llama" "\
...
(custom-autoload 'llama-fontify-mode "llama/llama" nil)

(autoload 'llama-fontify-mode "llama/llama" "\
...
(register-definition-prefixes "llama/llama" '("\\#\\#" "all-completions" "elisp-" "intern" "lisp--el-match-keyword@llama" "llama-"))

;;;***

;;;### (autoloads nil "llama/llama-tests" "llama/llama-tests.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from llama/llama-tests.el

(register-definition-prefixes "llama/llama-tests" '("llama-test--flatten"))
...
(autoload 'magit-stage-files "magit/lisp/magit-apply" "\
...
(autoload 'magit-run-post-stage-hook "magit/lisp/magit-apply")

(autoload 'magit-unstage-files "magit/lisp/magit-apply" "\
...
(autoload 'magit-run-post-unstage-hook "magit/lisp/magit-apply")
...
(autoload 'magit-auto-revert-buffers "magit/lisp/magit-autorevert")

(register-definition-prefixes "magit/lisp/magit-autorevert" '("auto-revert-buffer" "magit-"))

;;;***

;;;### (autoloads nil "magit/lisp/magit-base" "magit/lisp/magit-base.el"
;;;;;;  (0 0 0 0))
...
;;;***

;;;### (autoloads nil "magit/lisp/magit-bundle" "magit/lisp/magit-bundle.el"
;;;;;;  (0 0 0 0))
...
(autoload 'magit-commit-alter "magit/lisp/magit-commit" "\
...
(autoload 'magit-commit-revise "magit/lisp/magit-commit" "\
...
(autoload 'magit-run-post-commit-hook "magit/lisp/magit-commit")
...
;;;***

;;;### (autoloads nil "magit/lisp/magit-dired" "magit/lisp/magit-dired.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from magit/lisp/magit-dired.el

(autoload 'magit-dired-jump "magit/lisp/magit-dired" "\
...
(autoload 'magit-dired-stage "magit/lisp/magit-dired" "\
In Dired, staged all marked files or the file at point." t)

(autoload 'magit-dired-unstage "magit/lisp/magit-dired" "\
In Dired, unstaged all marked files or the file at point." t)

(autoload 'magit-dired-log "magit/lisp/magit-dired" "\
In Dired, show log for all marked files or the directory if none are marked.

\(fn &optional FOLLOW)" t)

(autoload 'magit-dired-am-apply-patches "magit/lisp/magit-dired" "\
...
(autoload 'magit-do-async-shell-command "magit/lisp/magit-dired" "\
...
(autoload 'magit-back-to-indentation "magit/lisp/magit-extras" "\
...
(autoload 'magit-file-stage "magit/lisp/magit-files" "\
Stage all changes to the file being visited in the current buffer." t)

(autoload 'magit-file-unstage "magit/lisp/magit-files" "\
Unstage all changes to the file being visited in the current buffer." t)

(autoload 'magit-file-untrack "magit/lisp/magit-files" "\
...
(autoload 'magit-file-rename "magit/lisp/magit-files" "\
...
(autoload 'magit-file-delete "magit/lisp/magit-files" "\
...
(register-definition-prefixes "magit/lisp/magit-files" '("lsp" "magit-"))
...
(autoload 'magit-delete-shelved-branch "magit/lisp/magit-log" "\
...
(autoload 'magit-merge-dissolve "magit/lisp/magit-merge" "\
...
(register-definition-prefixes "magit/lisp/magit-process" '("magit-"))
...
(autoload 'magit-add-section-hook "magit/lisp/magit-section" "\
...
(autoload 'magit--handle-bookmark "magit/lisp/magit-section" "\
...
(register-definition-prefixes "magit/lisp/magit-section" '("context-menu-region" "isearch-clean-overlays" "magit-"))
...
;;;***

;;;### (autoloads nil "magit/lisp/magit-sparse-checkout" "magit/lisp/magit-sparse-checkout.el"
;;;;;;  (0 0 0 0))
...
(autoload 'transient-inline-group "transient/lisp/transient" "\
...
(register-definition-prefixes "transient/lisp/transient" '("find-function-advised-original" "transient"))
...
;;;***

;;;### (autoloads nil "visible-mark/visible-mark" "visible-mark/visible-mark.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from visible-mark/visible-mark.el

(autoload 'visible-mark-mode "visible-mark/visible-mark" "\
...
(custom-autoload 'global-visible-mark-mode "visible-mark/visible-mark" nil)

(autoload 'global-visible-mark-mode "visible-mark/visible-mark" "\
...
(register-definition-prefixes "visible-mark/visible-mark" '("global-visible-mark-mode-exclude-alist" "visible-mark-"))
...
(register-definition-prefixes "web-mode/web-mode" '("web-mode-"))
