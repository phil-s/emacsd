...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pdf-tools" '(#("pdf-tools-" 0 10 (fontified nil face font-lock-function-name-face)))))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pdf-view" '(#("pdf-view-" 0 9 (fontified nil)))))
