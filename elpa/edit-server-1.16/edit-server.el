;;; edit-server.el --- server that responds to edit requests from Chrome  -*- lexical-binding: nil; -*-
...
(defgroup edit-server nil
  "Edit web browser textareas with Emacs."
  :group 'external)
...
You will want to look at the VALUE of \\='window-system\\=', \\='display\\='
and \\='terminal\\=' if you want to force any particular display type
and not default to whatever is currently open. If nil, the new
