...
;; This library is named after astronomical concepts regarding the
;; expansion and/or contraction of Space (i.e. the Universe).
;;
...
;; of relativity had predicted that the size of the Universe was variable;
;; however, believing this to be incorrect, he had introduced a "cosmological
;; constant" into his equations to counteract gravity, fixing the size of
;; Space to an invariant value.
