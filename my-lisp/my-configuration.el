...
(eval-when-compile
  ...
  (defvar dired-mark-region)
  (defvar dired-maybe-use-globstar)
  ...
  (defvar minibuffer-line-refresh-interval)
  (defvar posix-manual-url-browser-function)
